...
class IndividualsList(UserList):
    ...
    def _set_data(self, other: Union[IndividualsList, Iterable[Individual]]) -> IndividualsList:
    ...
    def _copy_with_data(self, other: Union[IndividualsList, Iterable[Individual]]) -> IndividualsList:
        new = copy(self)
        new._set_data(other)
        return new
    ...
    def apply(self, func: Callable[[PopulationT], PopulationT], inplace: bool = False) -> IndividualsList:
        ...
        if inplace:
            return self._set_data(result)
        else:
            return self._copy_with_data(result)
